...
const BitsPage = () => {
  // TODO: Replace with actual link to PDF regulation
      ...
      <div className="bg-bits-darkGray">
        ...
        <footer className="py-12 bg-gray-900 text-gray-400 border-t border-gray-700">
          <div className="container mx-auto px-4 text-center">
            <div className="mb-6">
              <Button variant="outline" className="border-bits-cyan text-bits-cyan hover:bg-bits-cyan hover:text-bits-darkGray" asChild>
            ...
            <div className="mb-4 text-sm">
              <a href="/termos-de-uso" className="hover:text-bits-cyan transition-colors px-2">Termos de Uso</a> | 
              <a href="/politica-de-privacidade" className="hover:text-bits-cyan transition-colors px-2">Política de Privacidade</a>
            </div>
