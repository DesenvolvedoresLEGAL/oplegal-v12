          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center p-8 bg-legal text-white rounded-3xl mb-8 shadow-2xl">
              ...
              <div className="text-left">
                <div className="text-4xl md:text-6xl font-black">1 MILHÃO</div>
                <div className="text-xl md:text-2xl">de conexões até 2030</div>
              </div>
            </div>
            <p className="text-2xl md:text-3xl font-bold text-legal mb-4">
              Conectar 1 milhão de pessoas, negócios e coisas no Brasil até 2030
            </p>
          </div>
