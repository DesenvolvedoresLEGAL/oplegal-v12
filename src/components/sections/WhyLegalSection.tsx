...
const WhyLegalSection = () => {
  const [count, setCount] = useState(155000);
  const targetCount = 155883;
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-legal rounded-xl p-8 text-white text-center max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
            <p className="text-sm mb-2">Até hoje já conectamos</p>
            <div className="text-4xl md:text-5xl font-mono font-bold tracking-wider">
              {count.toLocaleString()}
            </div>
            <p className="text-sm mt-2">conexões e contando...</p>
          </div>
        </div>
      </div>
    </section>
