...
const HumanoidPricingSection = () => {
  return (
    <section className="relative py-24 bg-gradient-to-br from-gray-900 via-legal/20 to-gray-900 overflow-hidden">
      {/* Background effects */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(3,249,255,0.1),transparent_50%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,rgba(2,12,188,0.1),transparent_50%)]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <TooltipProvider>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {/* Card 1 - ORIGIN */}
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 hover:border-legal-cyan/50 rounded-2xl p-6 md:p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-legal-cyan/20 animate-fade-up">
              <div className="space-y-6">
                <div className="space-y-3">
                  <Badge className="bg-legal-cyan/20 text-legal-cyan border-legal-cyan/30">
                    Microempreendedores
                  </Badge>
                  <h3 className="text-2xl font-black text-white">Origin</h3>
                  <p className="text-white/60 text-sm">MEI/ME</p>
                  <p className="text-white/90 font-bold">Energia inicial para começar agora</p>
                </div>
            ...
            {/* Card 2 - FUSION */}
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 hover:border-legal-cyan/50 rounded-2xl p-6 md:p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-legal-cyan/20 animate-fade-up" style={{ animationDelay: '0.1s' }}>
              <div className="space-y-6">
                <div className="space-y-3">
                  <Badge className="bg-legal-purple/20 text-legal-purple border-legal-purple/30">
                    Pequenas Empresas
                  </Badge>
                  <h3 className="text-2xl font-black text-white">Fusion</h3>
                  <p className="text-white/60 text-sm">Pequeno Porte</p>
                  <p className="text-white/90 font-bold">Energia para integrar e ganhar produtividade</p>
                </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border-2 border-legal rounded-2xl p-6 md:p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-legal/50 animate-fade-up relative" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <p className="text-white/60 text-sm">Médio Porte</p>
                  <p className="text-white/90 font-bold">Energia para escalar com controle</p>
                </div>
            ...
            {/* Card 4 - MATRIX */}
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 hover:border-legal-purple/50 rounded-2xl p-6 md:p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-legal-purple/20 animate-fade-up" style={{ animationDelay: '0.3s' }}>
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <h3 className="text-2xl font-black text-white">Matrix</h3>
                  <p className="text-white/60 text-sm">Corporações</p>
                  <p className="text-white/90 font-bold">Sob contrato — energia corporativa</p>
                </div>
        ...
        <div className="text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <p className="text-sm text-white/60 max-w-4xl mx-auto">
