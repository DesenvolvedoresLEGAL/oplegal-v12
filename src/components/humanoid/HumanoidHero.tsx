  ...
  return (
    <section className="py-24 md:py-32 text-center bg-gradient-to-br from-legal to-legal-purple text-white relative overflow-hidden">
      <div className="absolute inset-0 opacity-10" aria-hidden="true">
        ...
        <Target className="absolute bottom-10 right-10 w-24 h-24 text-white/10 animate-pulse animation-delay-500" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <header>
          ...
          <p className="text-lg md:text-xl font-light max-w-4xl mx-auto mb-8">
            <strong className="font-bold text-legal-cyan">Agente de IA para Captação de Leads e SDR Inteligente</strong> que 
            identifica oportunidades na internet, integra automaticamente com seu CRM e qualifica leads via WhatsApp e 
            ligações com inteligência artificial conversacional. Da prospecção à conversão, tudo automatizado.
          </p>
        </header>
        <nav className="flex flex-col sm:flex-row justify-center gap-4" role="navigation">
          <Button asChild size="lg" className="bg-legal-cyan hover:bg-legal-cyan/90 text-legal font-bold">
            <Link to="/contato?produto=humanoid">Começar Teste Gratuito</Link>
          </Button>
