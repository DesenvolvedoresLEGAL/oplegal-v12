  ...
  return (
    <>
      <SEOHead
        ...
        description="LEGAL é a maior TECHCO do Brasil criadora do Smart Events™. Transforme eventos corporativos com Inteligência Artificial, credenciamento facial FacePass™, conectividade 5G FWA, drones AERO e ROI comprovado. +3.000 eventos realizados, NPS 90+, redução de 40% nos custos operacionais."
