  ...
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-bits-purple mb-12 font-space">Aceleradores de Pontos BITS™</h2>
        <div className="grid md:grid-cols-2 gap-8">
          {accelerators.map((accel, index) => (
            <div key={index} className="flex items-start p-6 bg-bits-lightGray rounded-lg shadow-md border-l-4 border-bits-purple">
              <accel.icon size={40} className="mr-4 text-bits-purple flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-xl font-bold text-bits-purple mb-1">{accel.title}</h3>
