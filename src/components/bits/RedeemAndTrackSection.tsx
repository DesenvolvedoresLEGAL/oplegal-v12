  ...
  return (
    <section className="py-16 md:py-24 bg-bits-darkGray text-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-legal-cyan mb-12">Como Resgatar & Acompanhar Seus BITS</h2> {/* Cor e font-space atualizados */}
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="p-6">
            <MessageCircle size={56} className="mx-auto mb-4 text-legal-cyan" />
          ...
          <div className="p-6">
            <LayoutDashboard size={56} className="mx-auto mb-4 text-legal-cyan" />
          ...
          <div className="p-6">
            <BellRing size={56} className="mx-auto mb-4 text-legal-cyan" />
