...
import { ShoppingCart, UserPlus, CalendarCheck, RadioTower } from 'lucide-react';
  ...
  return (
    <section className="py-16 md:py-24 bg-bits-darkGray text-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-legal-cyan mb-12">Como Acumular Pontos BITS™</h2> {/* Cor e font-space atualizados */}
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {earningMethods.map((method, index) => (
            <div key={index} className="p-6 bg-gray-800/50 rounded-lg shadow-xl border border-legal-cyan/30 hover:border-legal-cyan transition-all duration-300 transform hover:scale-105">
              <method.icon size={48} className="mb-4 text-legal-cyan" />
