...
import { CheckCircle, Zap, Award, MessageCircle } from 'lucide-react'; // Award para gamificação, Zap para entrega rápida, CheckCircle para multicanalidade
  ...
  return (
    <section className="py-16 md:py-24 bg-bits-darkGray text-white">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-bits-cyan mb-12 font-space">Por que o BITS™ é Diferente?</h2>
        <div className="grid md:grid-cols-2 gap-x-8 gap-y-6 max-w-3xl mx-auto mb-12 text-left">
          {differentiators.map((item, index) => (
            <div key={index} className="flex items-center">
              <item.icon size={24} className="mr-3 text-bits-cyan flex-shrink-0" />
