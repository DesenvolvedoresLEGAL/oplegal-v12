      ...
      <div className="container mx-auto px-4 relative z-10">
        <header>
          ...
          <p className="text-lg md:text-xl font-light max-w-4xl mx-auto mb-8">
            <strong className="font-bold text-legal-cyan">Copiloto de Contratação e People Analytics com IA</strong> que revoluciona 
            processos de RH. Análise preditiva, matching inteligente e insights profundos para decisões de contratação mais assertivas.
          </p>
        </header>
        <nav className="flex flex-col sm:flex-row justify-center gap-4" role="navigation">
          <Button asChild size="lg" className="bg-legal-cyan hover:bg-legal-cyan/90 text-legal font-bold">
            <Link to="/contato?produto=fitscore">Solicitar Demonstração</Link>
          </Button>
