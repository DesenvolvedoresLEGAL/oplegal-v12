  ...
  return (
    <section className="py-24 md:py-32 text-center bg-gradient-to-br from-legal to-legal-purple text-white relative overflow-hidden">
      <div className="absolute inset-0 opacity-10" aria-hidden="true">
        <Mic className="absolute top-10 left-10 w-32 h-32 text-white/10 animate-pulse" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <header>
          <div className="flex items-center justify-center gap-3 mb-6">
            <Mic className="w-12 h-12 text-legal-cyan" />
          ...
          <p className="text-lg md:text-xl font-light max-w-4xl mx-auto mb-8">
            <strong className="font-bold text-legal-cyan">Plataforma de Áudio IA Inteligente</strong> que 
            transforma conversas em insights estratégicos. Transcrição automática, análise de sentimentos, 
            tradução instantânea e processamento avançado de áudio com precisão de 99,5%.
          </p>
        </header>
        <nav className="flex flex-col sm:flex-row justify-center gap-4" role="navigation">
          <Button asChild size="lg" className="bg-legal-cyan hover:bg-legal-cyan/90 text-legal font-bold">
            <Link to="/contato?produto=sonix">Análise Gratuita</Link>
          </Button>
