...
const Blue6Stats = () => {
  const stats = [
    { number: "1.2 Gbps", label: "Velocidade", description: "WiFi 6 de alta performance" },
    { number: "500+", label: "Usuários", description: "Simultâneos por ponto de acesso" },
    { number: "99.9%", label: "Uptime", description: "Disponibilidade garantida" },
    { number: "2km", label: "Alcance", description: "Cobertura externa máxima" }
  ];
